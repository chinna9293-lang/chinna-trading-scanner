...
export function superTrendSeries(bars, period = 10, multiplier = 3.0) {
...
export function utBotSeries(bars, atrPeriod = 10, keyValue = 1.5) {
...
export function swingStructure(bars, lookback = 20) {
  const n = bars.length;
...
export function rsiDivergence(closes, rsi, lookback = 14) {
...
export function evaluateStrategy(bars) {
  const n = bars.length;
  if (n < 55) return null;
